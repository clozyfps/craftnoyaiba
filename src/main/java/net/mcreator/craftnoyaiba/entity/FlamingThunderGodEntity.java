...
public class FlamingThunderGodEntity extends TamableAnimal implements GeoEntity {
	...
	public FlamingThunderGodEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(CraftnoyaibaModEntities.FLAMING_THUNDER_GOD.get(), world);
	}

	public FlamingThunderGodEntity(EntityType<FlamingThunderGodEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	public void baseTick() {
		super.baseTick();
		FlamingThunderGodOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		FlamingThunderGodEntity retval = CraftnoyaibaModEntities.FLAMING_THUNDER_GOD.get().create(serverWorld);
