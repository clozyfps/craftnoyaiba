...
public class ThunderClapAndFlashMobEntity extends Monster {
	...
	public ThunderClapAndFlashMobEntity(EntityType<ThunderClapAndFlashMobEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(true);
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		ThunderClapAndFlashMobOnInitialEntitySpawnProcedure.execute(world, this);
		return retval;
	}
