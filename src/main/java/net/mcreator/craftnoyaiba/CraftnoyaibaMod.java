package net.mcreator.craftnoyaiba;
...
import net.mcreator.craftnoyaiba.init.CraftnoyaibaModTabs;
import net.mcreator.craftnoyaiba.init.CraftnoyaibaModSounds;
...
@Mod("craftnoyaiba")
public class CraftnoyaibaMod {
	public static final Logger LOGGER = LogManager.getLogger(CraftnoyaibaMod.class);
	public static final String MODID = "craftnoyaiba";

	public CraftnoyaibaMod() {
		...
		CraftnoyaibaModTabs.REGISTRY.register(bus);

		CraftnoyaibaModMobEffects.REGISTRY.register(bus);

		CraftnoyaibaModParticleTypes.REGISTRY.register(bus);

		CraftnoyaibaModMenus.REGISTRY.register(bus);
