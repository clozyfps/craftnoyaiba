...
import net.mcreator.craftnoyaiba.procedures.BladeRightclickedProcedure;

import java.util.List;

public class BladeItem extends PickaxeItem {
	public BladeItem() {
		super(new Tier() {
			public int getUses() {
				return 100;
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		BladeRightclickedProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity);
		return ar;
	}
