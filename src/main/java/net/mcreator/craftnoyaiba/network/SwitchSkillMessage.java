...
import net.mcreator.craftnoyaiba.procedures.SwitchSkillOnKeyPressedProcedure;
...
public class SwitchSkillMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CraftnoyaibaMod.addNetworkMessage(SwitchSkillMessage.class, SwitchSkillMessage::buffer, SwitchSkillMessage::new, SwitchSkillMessage::handler);
	}
}
