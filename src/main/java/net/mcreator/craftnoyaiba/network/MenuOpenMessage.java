...
import net.mcreator.craftnoyaiba.procedures.MenuOpenOnKeyPressedProcedure;
...
public class MenuOpenMessage {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			MenuOpenOnKeyPressedProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		CraftnoyaibaMod.addNetworkMessage(MenuOpenMessage.class, MenuOpenMessage::buffer, MenuOpenMessage::new, MenuOpenMessage::handler);
	}
}
