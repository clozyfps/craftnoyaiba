...
public class Modeluppermoonone_armor<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("craftnoyaiba", "modeluppermoonone_armor"), "main");
	...
	public Modeluppermoonone_armor(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = Body.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(4, 96).addBox(-1.0F, -9.5F, -1.0F, 3.0F, 19.0F, 2.0F, new CubeDeformation(-0.46F)),
				PartPose.offsetAndRotation(4.9985F, 12.2389F, 1.4654F, 1.9069F, 0.4748F, 1.6838F));
		PartDefinition cube_r2 = Body.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(54, 37).addBox(-1.0F, -2.0F, 0.0F, 2.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.0F, 12.6193F, -2.8307F, -0.0807F, -0.0334F, -0.3914F));
		PartDefinition cube_r3 = Body.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(28, 50).addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.01F)),
				PartPose.offsetAndRotation(0.0F, 11.3333F, -2.3333F, -0.0873F, 0.0F, 0.0F));
		PartDefinition cube_r4 = Body.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(19, 32).addBox(-1.0F, -2.0F, 0.0F, 2.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.0F, 12.6193F, -2.9186F, -0.0807F, 0.0334F, 0.3914F));
		PartDefinition cube_r5 = Body.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(56, 13).addBox(-4.0F, -0.5F, -0.5F, 8.0F, 1.0F, 1.0F, new CubeDeformation(0.011F)),
				PartPose.offsetAndRotation(0.0F, 9.8333F, -1.8333F, 0.6109F, 0.0F, 0.0F));
		PartDefinition cube_r6 = Body.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(56, 11).addBox(-4.0F, -0.5F, -0.5F, 8.0F, 1.0F, 1.0F, new CubeDeformation(0.011F)),
				PartPose.offsetAndRotation(0.0F, 9.8333F, 1.8333F, -0.6109F, 0.0F, 0.0F));
		PartDefinition cube_r7 = Body.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(32, 71).addBox(-1.0F, -2.0F, -0.5F, 2.0F, 6.0F, 1.0F, new CubeDeformation(0.011F)),
				PartPose.offsetAndRotation(-2.1299F, 1.7782F, -1.6136F, 0.0F, 0.0F, -0.5236F));
		PartDefinition cube_r8 = Body.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(26, 70).addBox(-1.0F, -2.0F, -0.5F, 2.0F, 6.0F, 1.0F, new CubeDeformation(0.011F)),
				PartPose.offsetAndRotation(-1.4633F, 1.7782F, -1.5256F, 0.0F, 0.0F, -0.5236F));
		PartDefinition cube_r9 = Body.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(70, 15).addBox(-1.0F, -3.0F, -0.5F, 2.0F, 6.0F, 1.0F, new CubeDeformation(0.011F)),
				PartPose.offsetAndRotation(0.9633F, 2.6442F, -1.5067F, 0.0F, 0.0F, 0.5236F));
		PartDefinition cube_r10 = Body.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(74, 22).addBox(-1.0F, -3.0F, -0.5F, 2.0F, 6.0F, 1.0F, new CubeDeformation(0.011F)),
				PartPose.offsetAndRotation(-1.6935F, 2.6809F, -1.7969F, 0.0F, -0.1745F, -0.5236F));
		PartDefinition cube_r11 = Body.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(20, 72).addBox(-1.0F, -3.0F, -0.5F, 2.0F, 6.0F, 1.0F, new CubeDeformation(0.011F)),
				PartPose.offsetAndRotation(1.6935F, 2.6809F, -1.7969F, 0.0F, 0.1745F, 0.5236F));
		PartDefinition cube_r12 = Body.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(61, 70).addBox(-1.0F, -2.0F, -0.5F, 2.0F, 6.0F, 1.0F, new CubeDeformation(0.011F)),
				PartPose.offsetAndRotation(2.1299F, 1.7782F, -1.6136F, 0.0F, 0.0F, 0.5236F));
