...
public class Modelflashy_armor<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "flashy_armor"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = Head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 60).addBox(-4.0F, -1.5F, -0.5F, 8.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -5.5F, -4.5F, 0.0F, 0.0F, -0.1745F));

		PartDefinition cube_r2 = Head.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(11, 51).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F,
		...
		PartDefinition cube_r5 = Head.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(0, 51).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F,
						new CubeDeformation(-0.66F)),
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 17)
				.addBox(-4.0F, 10.0F, -2.0F, 8.0F, 2.0F, 4.0F, new CubeDeformation(0.2F)).texOffs(0, 0)
				.addBox(-4.0F, 2.75F, -2.0F, 8.0F, 7.0F, 4.0F, new CubeDeformation(0.25F)).texOffs(0, 30)
				.addBox(-2.0F, 0.75F, 1.175F, 4.0F, 9.0F, 1.0F, new CubeDeformation(0.25F)).texOffs(0, 11)
				.addBox(-4.0F, 0.25F, -2.0F, 8.0F, 2.0F, 4.0F, new CubeDeformation(0.26F)).texOffs(24, 28)
				.addBox(-0.9167F, 2.3333F, -2.9139F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.5F)).texOffs(12, 23)
				.addBox(-0.9167F, 4.6667F, -2.9139F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.5F)).texOffs(20, 0)
				.addBox(-0.9167F, 7.0F, -2.9139F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.5F)).texOffs(32, 33)
				.addBox(0.75F, 2.6667F, -2.8889F, 3.0F, 2.0F, 2.0F, new CubeDeformation(-0.5F)).texOffs(32, 19)
				.addBox(0.75F, 2.5F, -2.8889F, 3.0F, 2.0F, 2.0F, new CubeDeformation(-0.5F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition Body_r1 = Body.addOrReplaceChild("Body_r1",
				CubeListBuilder.create().texOffs(36, 0).addBox(-2.0F, -1.5F, -0.5F, 4.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 1.25F, -1.9167F, 0.4363F, 0.0F, 0.0F));

		PartDefinition cube_r16 = Body.addOrReplaceChild("cube_r16",
				CubeListBuilder.create().texOffs(20, 17).addBox(-4.0F, -0.5F, -0.5F, 8.0F, 1.0F, 1.0F,
						new CubeDeformation(0.25F)),
				PartPose.offsetAndRotation(0.0F, 10.0F, 1.5F, 0.6109F, 0.0F, 0.0F));

		PartDefinition cube_r17 = Body.addOrReplaceChild("cube_r17",
				CubeListBuilder.create().texOffs(24, 15).addBox(-4.0F, -0.5F, -0.5F, 8.0F, 1.0F, 1.0F,
						new CubeDeformation(0.25F)),
				PartPose.offsetAndRotation(0.0F, 10.0F, -1.5F, -0.6109F, 0.0F, 0.0F));

		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm",
				CubeListBuilder.create().texOffs(20, 7)
						.addBox(-3.0F, 6.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.026F)).texOffs(28, 28)
						.addBox(-3.0F, 5.6667F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.24F)).texOffs(12, 28)
		...
		PartDefinition cube_r18 = RightArm.addOrReplaceChild("cube_r18",
				CubeListBuilder.create().texOffs(19, 34).addBox(-2.5F, 2.1871F, -1.8847F, 4.0F, 1.0F, 0.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r19 = RightArm.addOrReplaceChild("cube_r19",
				CubeListBuilder.create().texOffs(36, 3).addBox(-2.0F, -0.5F, 0.0F, 4.0F, 1.0F, 0.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r20 = RightArm.addOrReplaceChild("cube_r20",
				CubeListBuilder.create().texOffs(20, 35).addBox(-2.0F, -0.5F, 0.0F, 4.0F, 1.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.0F, 5.1667F, 2.25F, -0.2618F, 0.0F, 0.0F));

		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(20, 7)
				.mirror().addBox(-1.0F, 6.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.026F)).mirror(false)
				.texOffs(28, 28).mirror().addBox(-1.0F, 5.6667F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.24F))
				.mirror(false).texOffs(12, 28).mirror()
				.addBox(-1.0F, 0.6667F, -2.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.26F)).mirror(false),
				PartPose.offset(5.0F, 2.0F, 0.0F));

		PartDefinition cube_r21 = LeftArm.addOrReplaceChild("cube_r21",
				CubeListBuilder.create().texOffs(19, 34).mirror()
						.addBox(-1.5F, 2.1871F, -1.8847F, 4.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(2.0F, 2.0833F, -0.4629F, 0.0F, -1.5708F, 0.2618F));

		PartDefinition cube_r22 = LeftArm.addOrReplaceChild("cube_r22",
				CubeListBuilder.create().texOffs(36, 3).mirror()
						.addBox(-2.0F, -0.5F, 0.0F, 4.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(1.0F, 5.1667F, -2.25F, 0.2618F, 0.0F, 0.0F));

		PartDefinition cube_r23 = LeftArm.addOrReplaceChild("cube_r23",
				CubeListBuilder.create().texOffs(20, 35).mirror()
						.addBox(-2.0F, -0.5F, 0.0F, 4.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(1.0F, 5.1667F, 2.25F, -0.2618F, 0.0F, 0.0F));

		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg",
				CubeListBuilder.create().texOffs(24, 0)
						.addBox(-2.0F, 9.0F, -2.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(36, 10)
						.addBox(-2.0F, 10.0F, -3.0F, 4.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(20, 19)
						.addBox(-2.1F, 1.0F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.25F)).texOffs(0, 23)
						.addBox(-2.1F, 6.0F, -2.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.21F)).texOffs(32, 7)
		...
		PartDefinition cube_r24 = RightLeg.addOrReplaceChild("cube_r24",
				CubeListBuilder.create().texOffs(24, 33).addBox(-1.0F, -1.5F, -2.0F, 2.0F, 3.0F, 4.0F,
		...
		PartDefinition cube_r25 = RightLeg.addOrReplaceChild("cube_r25",
				CubeListBuilder.create().texOffs(10, 34).addBox(-2.0F, -2.2875F, -0.4125F, 4.0F, 5.0F, 1.0F,
		...
		PartDefinition cube_r26 = RightLeg.addOrReplaceChild("cube_r26",
				CubeListBuilder.create().texOffs(36, 23).addBox(-2.0F, -3.4036F, -1.1098F, 4.0F, 1.0F, 1.0F,
		...
		PartDefinition cube_r27 = RightLeg.addOrReplaceChild("cube_r27",
				CubeListBuilder.create().texOffs(36, 13).addBox(-2.0F, 2.0199F, 1.0661F, 4.0F, 1.0F, 1.0F,
		...
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(24, 0)
				...
				.texOffs(36, 10).mirror().addBox(-2.0F, 10.0F, -3.0F, 4.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
				.mirror(false).texOffs(20, 19).mirror()
				.addBox(-1.9F, 1.0F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.25F)).mirror(false).texOffs(0, 23)
				.mirror().addBox(-1.9F, 6.0F, -2.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.21F)).mirror(false)
				.texOffs(32, 7).mirror().addBox(-1.9F, 0.0F, -1.0F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.25F))
		...
		PartDefinition cube_r33 = LeftLeg.addOrReplaceChild("cube_r33",
				CubeListBuilder.create().texOffs(10, 34).mirror()
		...
		PartDefinition cube_r34 = LeftLeg.addOrReplaceChild("cube_r34",
				CubeListBuilder.create().texOffs(36, 23).mirror()
		...
		PartDefinition cube_r35 = LeftLeg.addOrReplaceChild("cube_r35",
				CubeListBuilder.create().texOffs(36, 13).mirror()
		...
		PartDefinition cube_r36 = LeftLeg.addOrReplaceChild("cube_r36",
				CubeListBuilder.create().texOffs(38, 17).mirror()
		...
		PartDefinition cube_r39 = LeftLeg.addOrReplaceChild("cube_r39",
				CubeListBuilder.create().texOffs(35, 39).mirror()
						.addBox(0.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.24F)).mirror(false),
				PartPose.offsetAndRotation(-1.9F, 0.5F, -1.75F, -0.6109F, 0.0F, 0.0F));
