...
public class Modeluniform_long<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "uniform_long"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(12, 25)
				.addBox(-3.0F, -1.8F, -2.0F, 4.0F, 10.0F, 4.0F, new CubeDeformation(0.22F)),
				PartPose.offset(-5.0F, 2.0F, 0.0F));

		PartDefinition cube_r3 = RightArm.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(48, 51).addBox(-2.0F, -4.0F, -2.0F, 4.0F, 9.0F, 4.0F,
		...
		PartDefinition cube_r4 = RightArm.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(14, 59).addBox(-2.0F, -0.5F, -2.0F, 4.0F, 1.0F, 4.0F,
						new CubeDeformation(0.2F)),
		...
		PartDefinition cube_r5 = LeftArm.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(48, 51).mirror()
						.addBox(-2.0F, -4.0F, -2.0F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.2F)).mirror(false),
				PartPose.offsetAndRotation(1.25F, 3.4F, 0.0F, 0.0F, 0.0F, -0.1745F));

		PartDefinition cube_r6 = LeftArm.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(14, 59).mirror()
						.addBox(-2.0F, -0.5F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.2F)).mirror(false),
				PartPose.offsetAndRotation(1.1216F, 8.1624F, -0.01F, 0.0F, 0.0F, -0.1309F));

		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg",
				CubeListBuilder.create().texOffs(0, 20)
						.addBox(-2.0F, 9.0F, -2.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(40, 22)
						.addBox(-2.0F, 10.0F, -3.0F, 4.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(26, 46)
						.addBox(-2.1F, 1.5F, -2.0F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.25F)).texOffs(32, 16)
		...
		PartDefinition cube_r7 = RightLeg.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(28, 37).addBox(-2.0F, -2.5F, -0.5F, 4.0F, 5.0F, 1.0F,
		...
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(0, 20)
				...
				.mirror(false).texOffs(32, 16).mirror()
				.addBox(-1.9F, 0.0F, -1.0F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.25F)).mirror(false).texOffs(26, 46)
				.mirror().addBox(-1.9F, 1.5F, -2.0F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.25F)).mirror(false),
				PartPose.offset(1.9F, 12.0F, 0.0F));
		...
		PartDefinition cube_r16 = LeftLeg.addOrReplaceChild("cube_r16",
				CubeListBuilder.create().texOffs(28, 37).mirror()
						.addBox(-2.0F, -2.5F, -0.5F, 4.0F, 5.0F, 1.0F, new CubeDeformation(0.24F)).mirror(false),
				PartPose.offsetAndRotation(1.8344F, 5.2286F, 0.0F, 0.0F, -1.5708F, -0.0873F));
